...
@onready var skill_button: Button = $CanvasLayer/TurnActionButtons/SkillButton
@onready var skip_button: Button = $CanvasLayer/TurnActionButtons/SkipButton
@onready var run_button: Button = $CanvasLayer/TurnActionButtons/RunButton
...
func _ready() -> void:
	...
	skip_button.pressed.connect(_next_turn)
...
func _sort_turn_order_ascending(battler_1, battler_2) -> bool:
	return battler_1.stats_resource.dexternity < battler_2.stats_resource.dexternity

func _update_turn() -> void:
	if current_turn.stats_resource.type == StartingStats.BattlerType.PLAYER:
...
func _check_for_battle_end() -> bool:
	if enemy_battlers.is_empty():
		_show_battle_end_panel("Wygrałeś!")
		return true
	elif player_battlers.is_empty():
		_show_battle_end_panel("Przegrana!")
		return true
	return false
